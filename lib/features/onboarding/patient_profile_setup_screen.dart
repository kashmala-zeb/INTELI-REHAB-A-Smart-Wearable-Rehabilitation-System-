...
import 'package:inteli_rehab/features/onboarding/models/recovery_setup_model.dart';
import 'package:inteli_rehab/features/onboarding/notification_permission_screen.dart';
...
class _PatientProfileSetupScreenState extends State<PatientProfileSetupScreen>
  ...
  final TextEditingController _therapistCodeController = TextEditingController(
    text: OnboardingConstants.defaultTherapistCode,
  );
  ...
  Future<void> _handleCompleteProfile() async {
    _submitScaleController.forward().then(
      (_) => _submitScaleController.reverse(),
    );
          ...
          SafeArea(
            child: Center(
              child: SingleChildScrollView(
                physics:
                    const NeverScrollableScrollPhysics(), // Enforce non-scrollable page viewport
                child: Container(
                  width: double.infinity,
                  constraints: BoxConstraints(
                    maxHeight: isSmallScreen ? 680 : 760,
                  ),
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected
                        ? AppColors.tealCore.withOpacity(0.06)
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color: isSelected
                              ? AppColors.tealCore.withOpacity(0.12)
                              : Colors.white,
                        ),
                        child: Icon(
                          icon,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: _weekdays.map((day) {
                        final bool isDaySelected = _setupModel.selectedDays
                            .contains(day);
                        return GestureDetector(
                          onTap: () {
                            HapticFeedback.lightImpact();
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        stage == "Custom" && isSelected
                            ? _setupModel.reminderTime!
                            : val.split(' ')[0],
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 13,
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: AppColors.tealCore.withOpacity(0.25),
                      width: 4,
                    ),
                  ),
                  child: ClipOval(
            ...
            Row(
              ...
              children: [
                OutlinedButton(
                  ...
                  child: const Text(
                    "Choose Photo",
                    style: TextStyle(color: AppColors.tealCore),
                  ),
                ),
                const SizedBox(width: 14),
                TextButton(
          ...
          child: Column(
            children: [
              ...
              _buildSummaryRow(
                ...
                "Affected Arm",
                "${_setupModel.affectedArm ?? 'Right'} Arm",
              ),
              const Divider(color: Color(0xFFE2E8F0), height: 16),
              _buildSummaryRow(
                Icons.healing,
                "Focus Area",
                "${_setupModel.rehabArea ?? 'Shoulder'} Rehab",
              ),
              const Divider(color: Color(0xFFE2E8F0), height: 16),
              _buildSummaryRow(
                Icons.assessment,
                "Recovery Stage",
                "${_setupModel.recoveryStage ?? 'Intermediate'} Stage",
              ),
              const Divider(color: Color(0xFFE2E8F0), height: 16),
              _buildSummaryRow(
              ...
              _buildSummaryRow(
                Icons.alarm,
                "Daily Reminder",
                _setupModel.reminderTime ?? '8:00 AM',
              ),
            ],
          ),
        ),
