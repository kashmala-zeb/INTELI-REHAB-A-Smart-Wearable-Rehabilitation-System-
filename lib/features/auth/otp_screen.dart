...
import 'package:inteli_rehab/features/dashboard/dashboard_screen.dart';
            ...
            child: Column(
              ...
              children: [
                          ...
                          child: Stack(
                            ...
                            children: [
                              Positioned(
                                ...
                                width: 291.0 * ((isSmallScreen ? 40 : 50) / 568),
                                height: 457.0 * ((isSmallScreen ? 40 : 50) / 568),
                                child: Image.asset(
                              ...
                              Positioned(
                                ...
                                width: 331.0 * ((isSmallScreen ? 40 : 50) / 568),
                                height: 565.0 * ((isSmallScreen ? 40 : 50) / 568),
                                child: Image.asset(
                              ...
                              Positioned(
                                ...
                                width: 328.0 * ((isSmallScreen ? 40 : 50) / 568),
                                height: 327.0 * ((isSmallScreen ? 40 : 50) / 568),
                                child: Image.asset(
                              ...
                              Positioned(
                                ...
                                width: 443.0 * ((isSmallScreen ? 40 : 50) / 568),
                                height: 451.0 * ((isSmallScreen ? 40 : 50) / 568),
                                child: Image.asset(
                              ...
                              Positioned(
                                ...
                                width: 257.0 * ((isSmallScreen ? 40 : 50) / 568),
                                height: 260.0 * ((isSmallScreen ? 40 : 50) / 568),
                                child: Image.asset(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: const Icon(Icons.edit, color: Color(0xFF6B7280), size: 12),
                        ),
                      ],
                    ),
                  ],
                ...
                SizedBox(
                  ...
                  child: CustomPaint(
                    painter: _HeroIllustrationPainter(brandColor: AppColors.tealCore, accentColor: AppColors.tealBright),
                  ),
                ),
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Transform.translate(
                      offset: Offset(_shakeError ? _shakeAnimation.value * (1 - (_shakeController.value * 2)).clamp(-1, 1) : 0, 0),
                      child: child,
                    );
                  },
                  child: Container(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: OutlineInputBorder(
                                    ...
                                    borderSide: BorderSide(
                                      color: _controllers[idx].text.isNotEmpty ? const Color(0xFF22C55E) : const Color(0xFFE5E7EB),
                                    ),
                                  ),
                ...
                Center(
                  child: _canResend
                      ? TextButton.icon(
                          ...
                          icon: Icon(Icons.refresh, color: AppColors.tealCore, size: 14),
                          label: Text(
                            'Resend Code',
                            style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppColors.tealCore),
                          ),
                        )
                      : Text(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: _isOtpComplete() && !_isLoading && !_isSuccess
                          ...
                          : null,
                      color: !_isOtpComplete() || _isLoading || _isSuccess ? const Color(0xFFE5E7EB) : null,
                    ...
                    child: ElevatedButton(
                      onPressed: _isOtpComplete() && !_isLoading && !_isSuccess ? _handleVerify : null,
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Colors.transparent,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.help_outline, color: AppColors.tealCore, size: 16),
                      const SizedBox(width: 8),
                      const Expanded(
                        child: Text(
...
class _HeroIllustrationPainter extends CustomPainter {
  ...
  _HeroIllustrationPainter({required this.brandColor, required this.accentColor});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width * 0.2, size.height * 0.5), Offset(size.width * 0.8, size.height * 0.5), linePaint);
    canvas.drawLine(Offset(size.width * 0.5, size.height * 0.1), Offset(size.width * 0.5, size.height * 0.9), linePaint);

    // Draw nodes
    canvas.drawCircle(Offset(size.width * 0.2, size.height * 0.5), 4, nodePaint);
    canvas.drawCircle(Offset(size.width * 0.8, size.height * 0.5), 4, nodePaint);
    canvas.drawCircle(Offset(size.width * 0.5, size.height * 0.1), 4, nodePaint);
    canvas.drawCircle(Offset(size.width * 0.5, size.height * 0.9), 4, nodePaint);
