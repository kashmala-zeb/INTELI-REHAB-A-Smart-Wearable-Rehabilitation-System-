...
class _LiveExerciseScreenState extends State<LiveExerciseScreen>
  ...
  void initState() {
    ...
    final bool isPronation = widget.exerciseName.toLowerCase().contains(
      'pronation',
    );
    if (isPronation) {
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Column(
              children: [
                _TwinControlBtn(icon: Icons.refresh_rounded, onTap: onReset),
                const SizedBox(height: 6),
                _TwinControlBtn(icon: Icons.add_rounded, onTap: onZoomIn),
                const SizedBox(height: 6),
                _TwinControlBtn(icon: Icons.remove_rounded, onTap: onZoomOut),
              ],
            ),
          ),
        ],
...
class _TwinControlBtn extends StatelessWidget {
  ...
  const _TwinControlBtn({required this.icon, required this.onTap});
        ...
        children: [
          ...
          IconButton(
            icon: Icon(
              ...
              color: voiceEnabled ? _primary : Colors.grey,
              size: 20,
            ),
