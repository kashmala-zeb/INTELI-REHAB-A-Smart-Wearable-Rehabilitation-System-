    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // 2. Today's Rehabilitation Hero Card (Primary CTA)
          Container(
              ...
              children: [
                ...
                ElevatedButton(
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => Scaffold(
                          ...
                          body: const SafeArea(child: PlacementScreen()),
                        ),
                      ),
                    );
                  },
                  ...
                  child: const Row(
                    ...
                    children: [
                      Text("Begin Today's Session", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                      SizedBox(width: 8),
          ...
          // 3. Today's Schedule (Horizontal scrolling carousel for clean vertical control)
          const Text(
            "Today's Schedule",
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 6),
                          const Text(
                            "Move slowly and avoid sudden arm movements during rehabilitation.",
                            maxLines: 3,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              fontSize: 12,
                      ...
                      TextButton(
                        ...
                        child: const Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Text("Learn More", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                            Icon(Icons.chevron_right, size: 14),
                          ],
                        ),
                      ),
    ...
    return InkWell(
      onTap: () {
        ...
        final match = _exercises.firstWhere(
          (ex) => ex.title.toLowerCase().contains(exerciseName.toLowerCase()),
          orElse: () => _exercises[0],
        );
        _openExerciseDetail(match);
      },
      borderRadius: BorderRadius.circular(20),
      child: Container(
        width: 170,
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.bolt, color: AppColors.tealCore, size: 16),
              ),
              Text(
                title,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              border: Border.all(color: AppColors.tealCore.withValues(alpha: 0.2), width: 3),
            ),
            child: ClipOval(
              child: Image.asset(
                OnboardingConstants.defaultProfileImagePath,
